    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400 text-sm mt-1">Gerenciamento ativo de demandas</p>
        </div>
        <button onClick={openNewModal} className="bg-slate-100 text-slate-900 px-4 py-2 rounded-lg hover:bg-white text-sm font-medium transition-colors">
          + Nova Demanda
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        <Quadrant num={2} title="2. Planejar" desc="Importante, Não Urgente" bg="bg-blue-950/10 border-blue-900/30" />
        <Quadrant num={3} title="3. Delegar" desc="Urgente, Não Importante" bg="bg-amber-950/10 border-amber-900/30" />
        <Quadrant num={4} title="4. Eliminar" desc="Não Urgente, Não Importante" bg="bg-slate-800/10 border-slate-800/50" />
      </div>
